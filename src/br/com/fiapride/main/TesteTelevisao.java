...
public class TesteTelevisao {
    ...
    public static void main(String[] args) {
        ...
        Televisao televisao02 = new Televisao("Samsung", 30);
        ...
        System.out.println("Tamanho em polegadas: " + televisao01.getTamanhoPolegadas());
        System.out.println("Volume: " + televisao01.getVolume());
        System.out.println("Ligada?: " +televisao01.getEstaLigada());

        System.out.println("\nEstado Final da TV 02:");
        System.out.println("Marca: " + televisao02.getMarca());
        System.out.println("Tamanho em polegadas: " + televisao02.getTamanhoPolegadas());
